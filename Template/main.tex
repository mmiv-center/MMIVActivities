...
\def\ILMCode{Annual Scientific Report 2020} % Unique code for the ILM project
...
\def\columnseprulecolor{\color{Apricot}}
...
\begingroup
\thispagestyle{empty}
\AddToShipoutPicture*{\put(0,0){\includegraphics[height=\paperheight]{Pictures/FrontCover.jpg}}} % Image background
\centering
\vspace*{11.3cm}
...
\begin{center}
    ...
    \text{\color{Apricot} \mytitle}  % Modify the name of the colour used to suit your image
    
    \text{\color{White}\ILMCode} % Modify the name of the colour used to suit your image
...
\begin{multicols}{3}
    [
        \ssection{Geodesic distances in white matter}{\textbf{Hauke Bartsch, Dr. rer. nat.}\\https://github.com/mmiv-center/HeatEquation.git}
