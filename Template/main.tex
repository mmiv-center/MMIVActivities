...
\def\mytitle{MMIV} % Title of the ILM project
\def\ILMCode{Annual Report 2020/2021} % Unique code for the ILM project
...
\def\author{Noeska Smit, Alexander Lundervold, and Hauke Bartsch} % Your name.. 
...
%%[
\begin{document}
\renewcommand{\bibname}{Publications} % Adds in the link to your references
...
\begingroup
\thispagestyle{empty}
\AddToShipoutPicture*{\put(0,0){\includegraphics[height=\paperheight]{Pictures/cover2.png}}} % Image background
\centering
\vspace*{11.3cm}
...
\chapterimage{1Introduction.JPG}
\chapter{Introduction}
\newpage

%%PLACEHOLDERINTRODUCTIONS%%
...
\chapterimage{3ThematicAreas.JPG}
...
\chapterimage{6Dissertations.JPG}
...
\chapterimage{8Organization.JPG}
...
%\chapterimage{9Publications.JPG} % Chapter heading image
\chapterimage{Heading1.jpg} % Chapter heading image
\chapter{Publications}
\newpage
\nocite{*}
\bibliographystyle{habbrvyr} % Change this to IEEE or Harvard etc.
